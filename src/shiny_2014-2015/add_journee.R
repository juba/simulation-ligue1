...
add.journee <- function(championnat, saison, journee, nb.rep=5000) {
    ...
    cat("--- Scraping ---\n")
    source("src/shiny_2014-2015/scrape.R", local=TRUE)
    cat("--- Running simulations ---\n")
    source("src/shiny_2014-2015/run.R", local=TRUE)
}

## Ajout d'une nouvelle journée

add.journee("Ligue 1", "2014-2015", 34, 5000)

add.journee("Ligue 2", "2014-2015", 33, 5000)

add.journee("National", "2014-2015", 27, 5000)


# for (i in 21:26) {
#     cat(paste("\n\n---",i,"---\n"))
#     add.journee("Ligue 1", "2014-2015", i, 5000)
# }
# 
# for (i in 20:25) {
#     cat(paste("\n\n---",i,"---\n"))
#     add.journee("Ligue 2", "2014-2015", i, 5000)
# }
# 
# for (i in 19:23) {
#     cat(paste("\n\n---",i,"---\n"))
#     add.journee("National", "2014-2015", i, 5000)
# }
